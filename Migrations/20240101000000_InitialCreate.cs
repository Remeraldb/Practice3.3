...
//  Міграція 1 — початкова схема Northwind
//  (Генерується командою: dotnet ef migrations add InitialCreate)
// ============================================================
using System;
...
namespace NorthwindORM.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex("IX_Orders_EmployeeID",     "Orders",     "EmployeeID");
            migrationBuilder.CreateIndex("IX_Orders_ShipVia",        "Orders",     "ShipVia");
            ...
            migrationBuilder.CreateIndex("IX_Territories_RegionID",  "Territories","RegionID");
            migrationBuilder.CreateIndex("IX_Employees_ReportsTo",   "Employees",  "ReportsTo");
        }

        /// <inheritdoc />
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropTable("EmployeeTerritories");
            migrationBuilder.DropTable("Order Details");
            migrationBuilder.DropTable("CustomerCustomerDemo");
            migrationBuilder.DropTable("Territories");
            migrationBuilder.DropTable("Products");
            migrationBuilder.DropTable("Orders");
            migrationBuilder.DropTable("Region");
            migrationBuilder.DropTable("CustomerDemographics");
            migrationBuilder.DropTable("Customers");
            migrationBuilder.DropTable("Shippers");
